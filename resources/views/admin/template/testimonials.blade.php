     {{-- @foreach ($testimonials as $test)
         <div
             class="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-100 relative">
             ...
             <div class="border-t border-blue-100 pt-6">
                 <div class="flex items-center justify-between">
                     <div>
                         <h4 class="font-bold text-gray-900">{{ $test->name }}</h4>
                         <p class="text-sm text-gray-600">{{ $test->position }}</p>
                     </div>
     ...
     @if (!empty($reviews))
         <div class="google-reviews max-w-6xl mx-auto py-10 px-2 md:px-5">
             <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 p-4 text-center md:text-left"
             ...
             <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                 @foreach ($reviews->take(12) as $review)
