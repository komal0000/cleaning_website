...
<body>
    <div class="container">
        ...
        <div class="field">
            ...
            <div>{{ ucwords(str_replace('-', ' ', $application->position)) }}</div>
        </div>
        ...
        <div class="field">
            ...
            <div>{{ ucwords(str_replace('-', ' ', $application->availability)) }}</div>
        </div>
        ...
        @if($application->cover_letter && $application->cover_letter !== 'No cover letter provided')
        <div>
